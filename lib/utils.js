...
module.exports = {
  getAllServiceProxies() {
    if (
      this.serverless.service.proxies &&
      this.serverless.service.proxies.apiGatewayServiceProxies
    ) {
      return this.serverless.service.proxies.apiGatewayServiceProxies
    }
    return []
  },
