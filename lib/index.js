...
// IoT Data
const compileMethodsToIoTData = require('./package/iotdata/compileMethodsToIoTData')
const compileIamRoleToIoTData = require('./package/iotdata/compileIamRoleToIoTData')
const compileIoTDataServiceProxy = require('./package/iotdata/compileIoTDataServiceProxy')
    ...
    this.hooks = {
      'package:compileEvents': async () => {
        if (this.getAllServiceProxies().length > 0) {
          ...
          //IotData getProxy
          await this.compileIoTDataServiceProxy()
